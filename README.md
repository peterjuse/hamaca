...
``` 
Donde <host> puede es la dirección ip a la que escuchará las peticiones el proyecto. Con ello la aplicación web se levantara junto a todos los modulos desarrollados y estará listo para su utilización. 